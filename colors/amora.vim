...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi Constant ctermbg=NONE ctermfg=6 cterm=NONE guibg=NONE guifg=#a3bfff gui=NONE
    hi Error ctermbg=NONE ctermfg=9 cterm=NONE guibg=NONE guifg=#ff5999 gui=NONE
    ...
    hi PreProc ctermbg=NONE ctermfg=9 cterm=italic guibg=NONE guifg=#ff5999 gui=italic
    hi Special ctermbg=NONE ctermfg=13 cterm=NONE guibg=NONE guifg=#ff80d0 gui=NONE
    hi Statement ctermbg=NONE ctermfg=9 cterm=italic guibg=NONE guifg=#ff5999 gui=italic
    hi String ctermbg=NONE ctermfg=10 cterm=NONE guibg=NONE guifg=#87ffe1 gui=NONE
    ...
    hi Type ctermbg=NONE ctermfg=9 cterm=bold guibg=NONE guifg=#ff5999 gui=bold
    ...
    hi Title ctermbg=NONE ctermfg=9 cterm=bold guibg=NONE guifg=#ff5999 gui=bold
    hi CursorLine ctermbg=8 ctermfg=NONE cterm=NONE guibg=#36222f guifg=NONE gui=NONE
    hi LineNr ctermbg=16 ctermfg=7 cterm=italic guibg=#1f1a21 guifg=#6a445d gui=italic
    hi CursorLineNr ctermbg=8 ctermfg=9 cterm=bold guibg=#36222f guifg=#ff5999 gui=bold
    ...
    hi SpecialKey ctermbg=NONE ctermfg=9 cterm=NONE guibg=NONE guifg=#ff5999 gui=NONE
    ...
    hi SpellBad ctermbg=NONE ctermfg=15 cterm=NONE guibg=NONE guifg=#d9deff gui=NONE guisp=#ff5999
    hi SpellCap ctermbg=NONE ctermfg=15 cterm=NONE guibg=NONE guifg=#d9deff gui=NONE guisp=#b2abff
    hi SpellLocal ctermbg=NONE ctermfg=15 cterm=NONE guibg=NONE guifg=#d9deff gui=NONE guisp=#ff80d0
...
elseif &t_Co == 8 || $TERM !~# '^linux' || &t_Co == 16
    ...
    hi PreProc ctermbg=NONE ctermfg=red cterm=italic
    ...
    hi LineNr ctermbg=darkblack ctermfg=gray cterm=italic
...
let g:terminal_ansi_colors = [ '#241d26', '#ff3080', '#00ffc9', '#ffd0bf', '#998fff', '#ff4abe', '#a3bfff', '#6a445d', '#36222f', '#ff5999', '#87ffe1', '#ffe4db', '#b2abff', '#ff80d0', '#c4d6ff', '#d9deff', ]
