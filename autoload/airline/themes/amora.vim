...
" Visual mode
let s:V1 = [ s:bg , s:yellow , s:term_black , s:term_yellow ]
let s:V2 = [ s:bg , s:bglighter , s:term_black , s:term_grey ]
let s:V3 = [ s:yellow , s:bg , s:term_yellow, '' ]

" Replace mode
let s:R1 = [ s:fg , s:red , s:term_black, s:term_red ]
let s:R2 = [ s:fg , s:bglighter , s:term_black, s:term_grey ]
...
"      \ 'airline_tab':     [ s:fg , s:green ,  s:term_black, s:term_green  , '' ],
